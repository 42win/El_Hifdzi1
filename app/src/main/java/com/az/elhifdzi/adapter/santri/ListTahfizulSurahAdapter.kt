...
class ListTahfizulSurahAdapter (private val listData: List<TahfizulSurah>) : RecyclerView.Adapter<ListTahfizulSurahAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ListTahfizulSurahAdapter.ListViewHolder {
    ...
    override fun onBindViewHolder(holder: ListTahfizulSurahAdapter.ListViewHolder, position: Int) {
